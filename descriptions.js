...
    `,
    ...
    "Page:Doom": `
        ...
        <p>Você explora o sacrifício, o limite e a inevitabilidade para encontrar ordem no sofrimento. Ao explorar o potencial do Destino, você aprende a utilizar as restrições do sistema a seu favor, explorando as falhas da realidade para garantir que o fim seja exatamente como você planejou..</p>
    `,
    "Rogue:Doom": `
...
// --- TEXTOS DO SISTEMA ---
    ...
    "UI_Intro": `
        <div class="fade-in">
            <h1>TESTE DE CLASSPECT DA SBURBIO V2</h1>
            ...
            <p>Nova atualização, novo TUDO! Ou pelo menos boa parte. Claramente uma mudança visual aconteceu aqui, com uma inspiração muito óbvia. Algumas perguntas também foram alteradas em certos aspectos, enquanto outros receberão uma revisão no futuro. Tem muitas perguntas, então vamos por partes. Lembrando que estamos sempre felizes com comentários na nossa página do Twitter, @sburbio!</p>
            <p>As perguntas e pontuações são baseadas num coletivo de interpretações individuais e que discuti com meus amigos, GeraFTC, Star e Vozes de Anjos, que me ajudaram na confecção desse quiz. São as outras pessoas que fazem parte do projeto. Utilizamos muito do que pode ser lido no PDF "A Treatise on Classpecting", mesmo que não seja nossa fonte principal de interpretação.</p>
